...
namespace NuGetGallery
{
    ...
    public interface IPackageVulnerabilitiesCacheService
    {
        ...
        /// </summary>
        IReadOnlyDictionary<int, IReadOnlyList<PackageVulnerability>> GetVulnerabilitiesByIdDictionary(string packageId, TimeSpan checkListExpireTime, IPackageService packageService);
    }
}
